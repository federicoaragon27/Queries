SELECT 
    ...
    CASE
        WHEN bb.kind='visit' AND bb.result = 'successful' THEN timezone('America/Buenos_Aires',bb.created_at)::date
        ELSE NULL
    END as booking_creation_date,
...
FROM (SELECT
        ...
        CASE
            ...
            WHEN cp.buying_stage = 'signed' THEN cp.profile_ptr_id
            ELSE NULL
        END AS visited_id
